...
carro.adicionarPessoas = function(numeroDePessoas){
  ...
  if(carro.assentos === carro.quantidadeDePessoas && totalPessoas >= carro.assentos){
    return "O carro já está lotado";
  } 
  
  if(totalPessoas > carro.assentos){
    var pessoas = carro.assentos - carro.quantidadeDePessoas;
    var pluralOuSingular = pessoas === 1 ? "pessoa" : "pessoas";
    return "Só cabem mais " + pessoas + " " + pluralOuSingular + " !";
  }
